...
public interface ImesEmployeeSVC
{
    ...
    [OperationContract]
    bool PermissionCheck(int EmployeeID, int StationTypeID);

    [OperationContract]
    string ValidateSecond(string UserID, string PWD);

    [OperationContract]
    string ChangePWD(string UserID, string OldPWD, string NewPWD);
}
