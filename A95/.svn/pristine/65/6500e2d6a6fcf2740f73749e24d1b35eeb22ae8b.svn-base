...
namespace App.MyMES
{
    public static class ISiemensFactory
    {
        public static SimensService.SiemensSVCClient CreateServerClient()
        {
            Public_ public_ = new Public_();
            SimensService.SiemensSVCClient client = new SimensService.SiemensSVCClient();
