...
using App.MyMES.Frm_WH_Old;

namespace App.MyMES
{
    public partial class WH_Old_Form : DevExpress.XtraEditors.XtraForm
    {
        public WH_Old_Form()
        {
            InitializeComponent();
       ...
       // PartSelectSVCClient PartSelectSVC;
        ...
        WH_Edit_Old_Form v_WH_Edit_Form = new WH_Edit_Old_Form();
        WH_Edit_Detail_Old_Form v_WH_Edit_Detail_Form = new WH_Edit_Detail_Old_Form();
        ...
        private void MySearch()
        {
            ...
            DataTable DT_Main = SiemensSVC.GetShipment(S_Start, S_End, S_TypeID, List_Login.StationTypeID.ToString()).Tables[0];
        ...
        private void MySearchDetail()
        {
            try
            {
                ...
                DataTable DT_Detail = SiemensSVC.GetShipmentEntry(S_FInterID, List_Login.StationTypeID.ToString()).Tables[0];
        ...
        {
            I_SelectRowID = e.FocusedRowHandle;
            MySearchDetail();
        }
        ...
        {
            I_SelectRowID = e.RowHandle;
            MySearchDetail();

            if (e.Column.Name == "Col_Modify")
            {
            ...
            else if (e.Column.Name == "Col_Del")
            {
                ...
                if (S_FStatus == "0")
                {
                    ...
                    {
                        string S_Result = SiemensSVC.DeleteShipment(S_FInterID, List_Login.StationTypeID.ToString());
                        if (S_Result == "1")
                        {
                            MySearch();
                        }
        ...
        private void Btn_Report_Click(object sender, EventArgs e)
        {
            ...
            WH_Report_Old _Report = new WH_Report_Old();
            string S_Start = Date_Start.DateTime.ToString("yyyy-MM-dd");
            string S_End = Date_End.DateTime.ToString("yyyy-MM-dd");

            string S_TypeID = Com_Type.EditValue.ToString();
            DataTable DT_Report = SiemensSVC.GetShipmentReport(S_Start, S_End, S_TypeID, List_Login.StationTypeID.ToString()).Tables[0];
        ...
        {
            v_WH_Edit_Form.Show_WH_Edit_Form(v_WH_Edit_Form, "New", "", List_Login.StationTypeID.ToString(),SiemensSVC , MySearch);
        }

        private void Btn_Modify_Click(object sender, EventArgs e)
        {
            v_WH_Edit_Form.Show_WH_Edit_Form(v_WH_Edit_Form, "Mod", S_FInterID, List_Login.StationTypeID.ToString(), SiemensSVC, MySearch);
            //Btn_Modify.Enabled = false;  
        }
        ...
        private void Btn_Del_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Are you sure to delete the selected data?", "MSG", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.Yes)
            {
                ...
                if (S_FInterIDList != "")
                {
                    S_Result = SiemensSVC.DeleteMultiSelectShipment(S_FInterIDList, List_Login.StationTypeID.ToString());
                }

                if (S_Result == "1")
                {
                    MessageBox.Show("Delete succeed!", "MSG", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    MySearch();
                }
                else
                {
        ...
        private void UpdateFStatus(string FStatus)
        {
            ...
            if (S_FInterIDList != "")
            {
                S_Result = SiemensSVC.UpdateShipment_FStatus(S_FInterIDList, FStatus, List_Login.StationTypeID.ToString());
            }
        ...
        {
            //Btn_Modify_Click(sender, e);
            v_WH_Edit_Form.Show_WH_Edit_Form(v_WH_Edit_Form, "Att", S_FInterID,
                List_Login.StationTypeID.ToString() ,SiemensSVC, MySearch);
        }


        private void Btn_New2_Click(object sender, EventArgs e)
        {
            v_WH_Edit_Detail_Form.Show_WH_Edit_Detail(v_WH_Edit_Detail_Form, "New", S_FInterID, S_FDetailID,
                List_Login.StationTypeID.ToString(), SiemensSVC, MySearchDetail);
            Btn_New2.Enabled = false;
        }

        private void Btn_Modify2_Click(object sender, EventArgs e)
        {
            v_WH_Edit_Detail_Form.Show_WH_Edit_Detail(v_WH_Edit_Detail_Form, "Mod", S_FInterID, S_FDetailID, 
                List_Login.StationTypeID.ToString(), SiemensSVC, MySearchDetail);
            Btn_Modify2.Enabled = false;
        }
        ...
        private void Btn_Delete2_Click(object sender, EventArgs e)
        {
            ...
            {
                string S_Result = SiemensSVC.Edit_CO_WH_ShipmentEntry
                    (S_FDetailID, "0", S_FInterID, "0", "0", "0", "0", List_Login.StationTypeID.ToString() ,"Del");
                if (S_Result == "1")
                {
                    MySearchDetail();
                }
        ...
        {
            Import_Form v_Import_Form = new Import_Form();

            v_Import_Form.Show_Import_Form(v_Import_Form,SiemensSVC, List_Login, MySearch);
        }
    }
}
