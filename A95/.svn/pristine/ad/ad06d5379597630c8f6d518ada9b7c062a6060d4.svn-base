...
namespace App.MyMES
{
    public static class ImesHistoryFactory
    {
        public static mesHistoryService.ImesHistorySVCClient CreateServerClient()
        {
            Public_ public_ = new Public_();
            mesHistoryService.ImesHistorySVCClient client = new mesHistoryService.ImesHistorySVCClient();
