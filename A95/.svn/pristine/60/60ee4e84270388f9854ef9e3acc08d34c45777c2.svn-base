...
public interface ImesUnitSVC
{
    ...
    [OperationContract]
    string UpdatePart(mesUnit model);

    [OperationContract]
    mesUnit Get(int id);
    [OperationContract]
    mesUnit GetUnit(string SN);
    ...
    [OperationContract]
    string UpdateUnitStateID(mesUnit v_mesUnit);

    [OperationContract]
    string UpdateTTUnitStateID(mesUnit v_mesUnit, string PanelID);
}
