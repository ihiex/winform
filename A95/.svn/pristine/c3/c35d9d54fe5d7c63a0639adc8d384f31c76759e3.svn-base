...
namespace App.MyMES
{
    public partial class IQC_Form : FrmBase
    {
        ...
        private void txtChildSN_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    MessageInfo.Add_Info_MSG(Edt_MSG, "20027", "NG", List_Login.Language, new string[] { ChildSN });
                    txtChildSN.Focus();
                    txtChildSN.Text = "";
                    return;
                }
                ...
                {
                    MessageInfo.Add_Info_MSG(Edt_MSG, "20202", "NG", List_Login.Language);
                    Edt_SN.Text = "";
                    Edt_SN.Enabled = true;
                    Edt_SN.Focus();
                    txtChildSN.Text = "";
