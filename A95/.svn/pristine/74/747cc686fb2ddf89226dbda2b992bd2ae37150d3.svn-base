...
namespace App.MyMES
{
    public partial class FrmBase2 : DevExpress.XtraEditors.XtraForm
    {
        ...
        public virtual void Com_PartFamilyType_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        public virtual void Com_Part_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void PartEdtStatus(Boolean B_Status)
        {
            ...
            Com_LineGroup.Enabled = B_Status;
        ...
        private void FrmBase2_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                if (port1 != null)
