...
namespace App.MyMES
{
    public static class IluEmployeeGroupFactory
    {
        public static luEmployeeGroupService.IluEmployeeGroupSVCClient CreateServerClient()
        {
            Public_ public_ = new Public_();
            luEmployeeGroupService.IluEmployeeGroupSVCClient client = new luEmployeeGroupService.IluEmployeeGroupSVCClient();
