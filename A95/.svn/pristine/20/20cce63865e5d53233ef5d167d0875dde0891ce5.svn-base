...
namespace App.MyMES
{
    public static class ImesMaterialUnitFactory
    {
        public static mesMaterialUnitService.ImesMaterialUnitSVCClient CreateServerClient()
        {
            Public_ public_ = new Public_();
            mesMaterialUnitService.ImesMaterialUnitSVCClient client = new mesMaterialUnitService.ImesMaterialUnitSVCClient();
