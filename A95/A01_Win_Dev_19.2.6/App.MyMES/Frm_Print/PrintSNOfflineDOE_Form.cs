...
namespace App.MyMES
{
    public partial class PrintSNOfflineDOE_Form : FrmBase2
    {
        public PrintSNOfflineDOE_Form()
        {
            InitializeComponent();
        }
        ...
        private void Btn_CreateSN_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageInfo.Add_Info_MSG(Edt_MSG, "20009", "NG", List_Login.Language, new string[] { "参数格式长度为4位" }, "");
                return;
            }
