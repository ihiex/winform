...
namespace App.MyMES
{
    public partial class ToolingQCPrint : FrmBase
    {
                                    ...
                                    if (S_UpdateUnit.Substring(0, 1) != "E")
                                    {
                                        ...
                                        //if (List_Login.ApplicationTypeID == 1) //QCPrint
                                        {
                                            ...
                                            if (S_PrintResult != "OK")
                                            {
                                                ...
                                                MessageInfo.Add_Info_MSG(Edt_MSG, "20111", "NG", List_Login.Language, new string[] { ProMsg }, S_PrintResult.Replace("ERROR", ""));
                                            }
                                            else
                                            {
        ...
        private void ToolingQCPrint_Load(object sender, EventArgs e)
        {
