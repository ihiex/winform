...
namespace App.MyMES
{
    public partial class AssemblyPanlePartNew_Form : FrmBase
    {
        // 2021-07-02 测试
        bool COF = false;
        int ScanNumber = 1;
        ...
        public AssemblyPanlePartNew_Form()
        {
            InitializeComponent();
        }
        ...
        public override void FrmBase_Load(object sender, EventArgs e)
        {
            ...
            //public_.AddPart(Com_Part, "", base.Grid_Part);
        }
        ...
        private bool VerifyMianCode()
        {
            ...
            //max.xie 验证料号是否一致
            if (PartID != Com_Part.EditValue.ToString())
            {
                MessageInfo.Add_Info_MSG(Edt_MSG, "20300", "NG", List_Login.Language, new string[] { mainSN });
                txtMainSN.Focus();
                txtMainSN.Text = string.Empty;
                return false;
            }
