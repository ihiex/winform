...
namespace App.MyMES
{
    public static class DataCommitFactory
    {
        public static DataCommitService.DataCommitSVCClient CreateServerClient()
        {
            Public_ public_ = new Public_();
            DataCommitService.DataCommitSVCClient client = new DataCommitService.DataCommitSVCClient();
