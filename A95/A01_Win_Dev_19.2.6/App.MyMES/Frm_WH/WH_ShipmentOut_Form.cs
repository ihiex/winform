...
namespace App.MyMES
{
    public partial class WH_ShipmentOut_Form : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void txtMultipackSN_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                DataSet dsFDetailID = PartSelectSVC.uspCallProcedure("uspSetShipmentMultipack_Siemens", MultipackSN,
                ...
                if (PritType == "2" || (Result=="0" && PritType=="1"))
                {
                    ...
                    if (PritType == "2")
                    {
                        result = PartSelectSVC.uspPalletPackaging_Siemens(Com_Part.EditValue.ToString(),/////////////////////////////
