...
namespace MESLabel
{
	internal class PageCount : MESFuncObject
	{
		public PageCount(string name) : base(name, 0)
		{
		}
		...
		public override string Evaluate(ArrayList Params)
		{
			...
			if (labelObj.CAP > 0)
			{
				return Conversions.ToString(Math.Ceiling((double)labelObj.TotalLineRecord / (double)labelObj.CAP));
			}
