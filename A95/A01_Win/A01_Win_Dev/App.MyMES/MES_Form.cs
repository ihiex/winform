        ...
        private void MES_Form_Load(object sender, EventArgs e)
        {
            ...
            else if (F_LoginList.StationType == "UPC_LablePrint")
            {
                ShowForm<PrintSN_UPC_Form>();
                 ...
                 //|| F_LoginList.ApplicationType == "QCPrint"
            ...
            else if (F_LoginList.ApplicationType == "ToolingQC")
            {
                ShowForm<ToolingOverStation_Form>();
            }
            else if (F_LoginList.ApplicationType == "ToolingQCNGPrint")
            {
                ShowForm<ToolingQCNGPrint>();
            }
            else if (F_LoginList.ApplicationType == "ToolingQCPrint")
            {
                ShowForm<ToolingQCPrint>();
            }

            else if (F_LoginList.ApplicationType == "Interlock")
            {
            ...
            else if (F_LoginList.ApplicationType == "UnitReplaceTool")   //////////////////
            {
            ...
            else if (F_LoginList.ApplicationType == "Plasma")
            {
                ShowForm<PlasmaForm>();
            }

            else if (F_LoginList.ApplicationType == "Assembly")
            {
                ShowForm<Assemble_Form>();
            }
            else if (F_LoginList.ApplicationType == "ToolingAssembly")
            {
                ShowForm<ToolingAssemble_Form>();
            }
            else  if(F_LoginList.ApplicationType == "ToolingLinkTooling")
            {
