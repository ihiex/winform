...
namespace App.MyMES
{
    public class Public_
    {
        ...
        public void Add_Info_MSG(RichTextBox Edt_MSG, string S_MSG, string S_Type)
        {
            string S_TypeData = "";
            if (S_Type == "OK")
            {
            ...
            Edt_MSG.Text += DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss:fff") + "  " + S_MSG + S_TypeData + "\r\n";
            ...
            try
            {
                ...
                if (S_Type == "NG")
                {
                    ...
                    //Edt_MSG.ForeColor = Color.Red;
                }
                else if (S_Type == "OK")
                {
                    Sound_OK.Play();
                    //Edt_MSG.ForeColor = Color.Black;
                    //Edt_MSG.BackColor = Color.White;
                    //  Edt_MSG.ForeColor = Color.Green;
                }
